...
import kotlinx.android.synthetic.main.activity_add_place.titleImg
import kotlinx.android.synthetic.main.activity_add_place.titleText
...
class AddPlaceActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        placebackbtn.setOnClickListener {
            onBackPressed()
            finish()
        }
        ...
        placeaddbtn.setOnClickListener {
            addPlan(
                tripId,
                placename.text.toString(),
                planImg!!,
                checkInDate!!,
                placestate.text.toString(),
                placecity.text.toString(),
                placeaddress.text.toString(),
                0,
                true,
                "",
                placedesc.text.toString(),
                "",
                11,
                ""
            )
    ...
    private fun pickCustDate() {
        ...
        picker.setOnButtonClickListener(object : SwitchDateTimeDialogFragment.OnButtonClickListener{
            ...
            override fun onPositiveButtonClick(date: Date?) {
                ...
                placedate.text = SimpleDateFormat("MMM, dd yyyy   hh:mm a").format(date)
            }
