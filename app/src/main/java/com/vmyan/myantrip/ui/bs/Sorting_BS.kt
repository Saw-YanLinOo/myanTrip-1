...
import com.vmyan.myantrip.ui.booking.bus.hotel.HotelRoomList
import com.vmyan.myantrip.ui.booking.bus.hotel.HotelStepper
...
class Sorting_BS : BottomSheetDialogFragment(){
    private var bottomSheetBehavior: BottomSheetBehavior<*>? = null
    lateinit var sorting : Sorting
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        val bottomSheet =
            super.onCreateDialog(savedInstanceState) as BottomSheetDialog
       sorting=(activity as TrainViewList)
